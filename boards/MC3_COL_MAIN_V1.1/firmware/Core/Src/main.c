...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, GPIO_PIN_13|GPIO_PIN_5|GPIO_PIN_6|GPIO_PIN_7
  ...
  /*Configure GPIO pins : PC1 PC3 PC8 PC12 */
  GPIO_InitStruct.Pin = GPIO_PIN_1|GPIO_PIN_3|GPIO_PIN_8|GPIO_PIN_12;
